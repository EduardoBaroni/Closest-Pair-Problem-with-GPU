...
int main(void){
	...
	int minX, maxX, minY, maxY; // Limites do intervalo dos valores
	int aux;
	...
	// Laço gerador das coordenadas para serem escritas no arquivo. Em X e em Y teremos intervalos informados pelo usuário.

	// Primeiro informamos os dados de X:
	...
	// Em segundo informamos os dados de Y:
	for(int i = 0; i < num_pontos ; i++){
