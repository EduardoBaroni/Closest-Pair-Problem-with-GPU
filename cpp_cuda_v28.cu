...
int main(int argc, char *argv[])
{
	...
	thrust::device_vector<float> dD; // Vetor de Distâncias (para o delta inicial) no device
	thrust::device_vector<float> dMin; // Vetor de minimos
...
/*-----------------------------------------------------------------------------------------------------------------*/
	...
	clock_t inicio_calc_distancias = clock();
 	...
 	dD.resize(num_pontos-1); // Alocando espaço para vector dD para poder apontar para ele
...
/*-----------------------------------------------------------------------------------------------------------------*/
	...
	dMin.resize(num_pontos, INT_MAX); // Alocando espaço para vetor dMin
