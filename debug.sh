...
for (( i = 0; 5 > i; i++)); do
	!./paralelo28 nPontos.bin coordenadas.bin >> seq9.txt			
done
for (( i = 0; 5 > i; i++)); do
	!./paralelo29 nPontos.bin coordenadas.bin >> seq9.txt			
done
for (( i = 0; 5 > i; i++)); do
	!./paralelo30 nPontos.bin coordenadas.bin >> seq9.txt			
done
for (( i = 0; 5 > i; i++)); do
	!./paralelo31 nPontos.bin coordenadas.bin >> seq9.txt			
done
for (( i = 0; 5 > i; i++)); do
	!./paralelo32 nPontos.bin coordenadas.bin >> seq9.txt			
done
